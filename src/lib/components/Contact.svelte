...
<section class="py-20 px-6 bg-muted/30">
  <div class="max-w-6xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
      ...
      <div use:reveal={{ delay: 0 }} class="md:col-span-2 md:row-span-2 group min-h-[280px]">
        <div 
        ...
        >
          <div class="h-full rounded-2xl border border-border bg-card/85 backdrop-blur-xl transition-all duration-500 group-hover:border-highlight/60 group-hover:bg-card/95 group-hover:shadow-[0_20px_50px_-20px_rgba(0,0,0,0.6),0_0_30px_-15px_hsl(var(--highlight)/0.3)] relative p-8 flex flex-col justify-between">
            ...
            <div class="absolute inset-0 rounded-2xl overflow-hidden pointer-events-none z-0">
              ...
              <div class="absolute inset-0 w-full h-full pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <div class="absolute top-0 -left-full w-48 h-full bg-linear-to-r from-transparent via-highlight/12 to-transparent skew-x-[-20deg] group-hover:animate-shimmer"></div>
              </div>
              <!-- Wave Background -->
            ...
            <div class="relative z-10 flex flex-col justify-between h-full w-full">
              ...
              <div class="flex items-center space-x-3 text-muted-foreground text-xs sm:text-sm font-medium pt-6 border-t border-border/30 mt-6">
      ...
      <div 
        use:reveal={{ delay: 80 }} 
        class="group relative {sendEmailOpen ? 'z-30' : 'z-10 hover:z-20'}"
      >
        <div 
      ...
      <div use:reveal={{ delay: 160 }} class="group">
        <div 
          use:tilt={{ max: 10, perspective: 1500, scale: 1.02 }}
          class="h-full relative transition-all duration-300 ease-out transform-3d"
        >
      ...
      <div use:reveal={{ delay: 240 }} class="group">
        <div 
          use:tilt={{ max: 10, perspective: 1500, scale: 1.02 }}
          class="h-full relative transition-all duration-300 ease-out transform-3d"
        >
      ...
      <div use:reveal={{ delay: 320 }} class="group">
        <div 
          use:tilt={{ max: 10, perspective: 1500, scale: 1.02 }}
          class="h-full relative transition-all duration-300 ease-out transform-3d"
        >
      ...
      <div use:reveal={{ delay: 400 }} class="group">
        <div 
          use:tilt={{ max: 10, perspective: 1500, scale: 1.02 }}
          class="h-full relative transition-all duration-300 ease-out transform-3d"
        >
