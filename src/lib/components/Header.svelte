    ...
    <nav class="flex items-center gap-8">
      ...
      <div class="flex items-center space-x-1 sm:space-x-2">
        ...
        <div class="hidden sm:flex items-center space-x-2">
          ...
          <Button class="rounded-full bg-highlight text-highlight-foreground hover:bg-highlight/90 ml-2 btn-cv-glow" href="/Aaditya_Raj_CV.pdf?v=20260820" download="Aaditya_Raj_CV.pdf" aria-label="Download CV PDF">
      ...
      <div class="flex flex-col space-y-4">
        ...
        <div class="pt-4 border-t border-border/50 flex flex-col gap-3">
          <div class="flex gap-2">
            ...
            <Button class="flex-1 h-12 rounded-full bg-highlight text-highlight-foreground font-bold" href="/Aaditya_Raj_CV.pdf?v=20260820" download="Aaditya_Raj_CV.pdf">
              <DownloadIcon height="16" class="mr-2" />
              CV
            </Button>
          </div>
