              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-foreground/90">Lalitpur, Nepal</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="relative overflow-hidden">
                      <AnimatePresence mode="wait">
                        <motion.a
                          ...
                          className="text-foreground hover:text-highlight transition-colors block"
                          initial={{ opacity: 0, y: 20 }}
                          animate={{ opacity: 1, y: 0 }}
                          exit={{ opacity: 0, y: -20 }}
                          transition={{ duration: 0.5, ease: "easeInOut" }}
                        >
                          <span className="font-semibold">{emails[currentEmailIndex].address}</span>
                          <span className="text-sm text-foreground/85 ml-2">({emails[currentEmailIndex].provider})</span>
                        </motion.a>
                      </AnimatePresence>
                    </div>
                  </div>
